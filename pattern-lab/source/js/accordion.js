    ...
    accordions.forEach(accordion => {
        ...
        buttons.forEach(button =>{
            button.addEventListener('keyup', event => {
                    if (event.keyCode == 32 || event.keyCode == 13) { //escape
            ...
            button.addEventListener('click', event => {
                ...
                const secContent = eventSelector.parentNode.querySelector('.section-content'),
                      secItem = secContent.querySelector('.section-item'),
                      openIcon = eventSelector.querySelector('.pe-icon--dropdown-open-18'),
                      closeIcon = eventSelector.querySelector('.pe-icon--dropdown-close-18'),
