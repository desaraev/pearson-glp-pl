...
(function() {
    ...
    let stylePanel = (e) => {
        ...
        redlines.elementname = e.dataset ? e.dataset.name || e.className || e.tagName : e.className || e.tagName;
        ...
        if ( pt ){
          ...
          redlines.hexfill = spectrumfill.indexOf('transparent') < 0 ? rgbtohex(fillcolor) : 'na';
          redlines.fillcolorname = colorNames.get(redlines.hexfill);
        
          redlines.fill = spectrumfill.indexOf('transparent') < 0 ? 'block' : 'none';
        
          redlines.fontHex = spectrumfont !== 'transparent' ? rgbtohex(redlines.fontRGB) : 'na';
          ...
          redlines.borderSwatch = redlines.borderColor && redlines.borderColor != 'transparent' ? whatcolor(redlines.borderColor) : '--';
          redlines.borderColorHex = redlines.borderColor && redlines.borderColor != 'transparent' ? rgbtohex(redlines.borderColor) : '--';
...
let whatcolor= (x) => {
    var stops = [colorstops.light, colorstops.dark, colorstops.extradark, colorstops.white];
  ...
  let commoncolors = {
    ...
    let paneldrag = (e) => {
      ...
      let eject = () => {
        ...
        document.getElementsByClassName('redlinepanel')[0].style.visibility = "hidden";
      };


      let colorMapping = [
          ['#047A9C', '$primary'], ['#005A70', '$primary-two'], ['#FFFFFF', '$primary-three'], ['#F5F5F5', '$primary-four'],
          ['#FFB81C', '$secondary'], ['#FF9A19', '$secondary-two'], ['#DAF0ED', '$secondary-three'], ['#19A6A4', '$secondary-four'], ['#179599', '$secondary-five'],
          ['#C7C7C7', '$neutral'], ['#252525', '$neutral-two'], ['#6A7070', '$neutral-three'], ['#D9D9D9', '$neutral-four'], ['#E9E9E9', '$neutral-five'], ['#f5f5f5', '$neutral-six'],
          ['#DB0020', '$condition-one'], ['#038238', '$condition-two'], ['#DA0474', '$condition-three']
      ];
